...
class Bgc:
    ...
    Attributes:
        ...
        gcf_id (str): The BiG-SCAPE gene cluster family this BGC belongs to, at the cutoff selected with --bigscape-cutoff. None when BiG-SCAPE was not run or no family was found for this BGC.
    """
    ...
    gene_count: int = 0
    gcf_id: Optional[str] = None # BiG-SCAPE gene cluster family
